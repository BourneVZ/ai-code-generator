...
public class UserController {
    ...
    public BaseResponse<UserVO> getUserVOById(long id) {
        BaseResponse<User> response = getUserByIdByAdmin(id);
    ...
    public BaseResponse<Long> addUserByAdmin(@RequestBody UserAddRequest userAddRequest) {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<User> getUserByIdByAdmin(long id) {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> deleteUserByAdmin(@RequestBody DeleteRequest deleteRequest) {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> updateUserByAdmin(@RequestBody UserUpdateRequest userUpdateRequest) {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Page<UserVO>> listUserVOByPageByAdmin(@RequestBody UserQueryRequest userQueryRequest) {
